...
var flavor_text = {
	...
	11: 'Frugo                                  Using two propellers these frog-like creatures manover elegantly the air. They will grant the slime two more dashes but decrease the distance from each slightly. They are a bit shy and only stay for two levels.',
